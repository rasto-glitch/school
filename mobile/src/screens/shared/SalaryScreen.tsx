...
// Shared "My Salary" screen. Teacher and supervisor render this verbatim —
// only the fetcher differs (teacherApi.getSalary / supervisorApi.getSalary,
// both hitting the role-agnostic getMyStaffInfo backend handler). Keeping
// one component guarantees the two screens never drift.
...
export interface SalaryScreenProps {
  fetchSalary: () => Promise<{ data?: { staff?: StaffInfo | null; payments?: SalaryPayment[] } }>;
}
...
export default function SalaryScreen({ fetchSalary }: SalaryScreenProps) {
