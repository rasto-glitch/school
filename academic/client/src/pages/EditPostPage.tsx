...
export default function EditPostPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([academicApi.getPost(id), academicApi.getClasses(), meReq]).then(([postRes, classRes, meRes]) => {
      ...
      setAllSubjects(Array.isArray(me?.subjects) ? me.subjects : []);
      setTeaching(Array.isArray(me?.teaching) ? me.teaching : []);
          ...
          <div className="space-y-5">
            ...
            {post?.content_type === 'richtext' && (
              <div>
                ...
                <RichTextEditor content={content} onChange={setContent} onUploadImage={uploadImage} />
              </div>
            )}
